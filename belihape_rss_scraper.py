#!/usr/bin/env python3
"""
BeliHape.id RSS Feed Scraper - Berita
======================================================
Menggunakan Playwright (headless browser) untuk bypass Cloudflare.
Scrape halaman berita + konten artikel lengkap (multi-page 1-10).
...
BASE_URL = "https://www.belihape.id"
CATEGORY_URL = "https://www.belihape.id/berita"

MAX_ARTICLES = 20

FEED_TITLE = "Beli Hape - Berita"
FEED_DESCRIPTION = "RSS Feed Berita dari belihape.id dengan konten artikel lengkap"
FEED_LINK = "https://www.belihape.id/berita"
...
def parse_list_page(url):
    ...
    if headline:
        ...
        if href and title and '/berita/' in href:
...
<rss version="2.0"
  ...
  <channel>
    ...
    <generator>BeliHape RSS Scraper - Playwright (GitHub Actions)</generator>
'''
...
def main():
    """Fungsi utama."""
    print("=" * 60)
    print("  BeliHape.id RSS Scraper - Berita (Playwright)")
    print("=" * 60)
